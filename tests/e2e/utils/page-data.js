...
const menuList = [
  ...
  { route: 'wscodegen', name: 'WebService 代码生成', hash: '#/wscodegen' },
...
const pageMeta = {
  ...
  wscodegen: { name: 'WebService 代码生成', expectedCrumb: 'WebService 代码生成', expectedTitle: 'WebService 代码生成', hasDangerButtons: false },
  ...
  compare: { name: '文件与文本比较', expectedCrumb: '文件与文本比较', expectedTitle: '文本 / 文件比较', hasDangerButtons: false },
...
const apiList = [
  ...
  '/api/wscodegen/download-zip',
  '/api/wscodegen/push-project',
  '/api/waspack/preview',
  '/api/waspack/build',
  '/api/waspack/open',
  '/api/notes',
...
const homeCards = [
  ...
  { name: 'WebService 代码生成', route: 'wscodegen' },
