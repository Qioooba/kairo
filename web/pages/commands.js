...
(function () {
  ...
  const COMMANDS = [
    ...
    { id: 'docker-run', category: 'docker', title: 'docker run 启动容器', tags: ['运行','启动','容器'],
      syntax: 'docker run -d --name web -p 8080:80 -v /host/path:/container/path nginx:1.25',
