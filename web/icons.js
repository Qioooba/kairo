...
(function () {
  ...
  const THEMES = {
    // dark → 月亮（深色）
    moon: `<path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401z" fill="#1e293b"/><path d="M20.985 12.486a9 9 0 0 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401z" fill="#475569" opacity="0.4"/>`,
    // light → 太阳（黄色）
