...
# 例如：
#   ./scripts/release_smoke_test.sh ./dist/ops-toolbox-src-v0.9.tar.gz
...
# tar.gz 内可能有顶层目录（如 ops-toolbox-v0.9/），找到它
SRC_DIR="${TMP_DIR}"
